...
INLINE auto const operator+ ( dX_real::dx_real<T,A> const& a, Ts const& b ) {
  auto const b_ = T(b);
  return dX_real::operator_add ( a, b_ );
}
template < typename T, Algorithm A, typename Ts, IF_T_scalar<Ts> >
INLINE auto const operator+ ( Ts const& a, dX_real::dx_real<T,A> const& b ) {
  return b + a;
}
//
...
//
template < typename T, Algorithm Aa, Algorithm Ab >
INLINE auto const operator_add_ow_body ( dX_real::dx_real<T,Aa> & a, qX_real::qx_real<T,Ab> const& b ) {
  Algorithm constexpr A=commonAlgorithm<Aa,Ab>::algorithm;
  if ( A == Algorithm::Accurate ) {
...
template < typename T, Algorithm Aa, Algorithm Ab >
INLINE auto const operator_add_ow_body ( dX_real::dx_real<T,Aa> & a, tX_real::tx_real<T,Ab> const& b ) {
  Algorithm constexpr A=commonAlgorithm<Aa,Ab>::algorithm;
  if ( A == Algorithm::Accurate ) {
...
template < typename T, Algorithm Aa, Algorithm Ab >
INLINE auto const operator_add_ow_body ( dX_real::dx_real<T,Aa> & a, dX_real::dx_real<T,Ab> const& b ) {
  Algorithm constexpr A=commonAlgorithm<Aa,Ab>::algorithm;
  if ( A == Algorithm::Accurate ) {
...
template < typename T, Algorithm Aa >
INLINE auto const operator_add_ow_body ( dX_real::dx_real<T,Aa> & a, T const& b ) {
  if ( Aa == Algorithm::Accurate ) {
...
INLINE auto const operator_add_ow ( dX_real::dx_real<Ta,Aa> & a, TXb const& b )
...
INLINE auto const operator_add_ow ( dX_real::dx_real<T,A> & a, T const& b )
-> dX_real::dx_real<T,A> {
#if MX_REAL_USE_INF_NAN_EXCEPTION
  bool flag;
  auto e = dX_real::operator_add_exception ( a, b, flag );
...
//
template < typename Ta, Algorithm Aa, typename TXb, IF_T_mX<TXb> >
INLINE auto const operator+= ( dX_real::dx_real<Ta,Aa> & a, TXb const& b )
-> return_TXA<TXb,Ta,Aa,2> {
  return dX_real::operator_add_ow ( a, b );
}
template < typename T, Algorithm A, typename Ts, IF_T_scalar<Ts> >
INLINE auto const operator+= ( dX_real::dx_real<T,A> & a, Ts const& b ) {
  auto const b_ = T(b);
...
//
template < typename T, Algorithm Aa, Algorithm Ab >
INLINE auto const operator_mul_ow_body ( dX_real::dx_real<T,Aa> & a, qX_real::qx_real<T,Ab> const& b ) {
  Algorithm constexpr A=commonAlgorithm<Aa,Ab>::algorithm;
  if ( A == Algorithm::Accurate ) {
...
template < typename T, Algorithm Aa, Algorithm Ab >
INLINE auto const operator_mul_ow_body ( dX_real::dx_real<T,Aa> & a, tX_real::tx_real<T,Ab> const& b ) {
  Algorithm constexpr A=commonAlgorithm<Aa,Ab>::algorithm;
  if ( A == Algorithm::Accurate ) {
...
template < typename T, Algorithm Aa, Algorithm Ab >
INLINE auto const operator_mul_ow_body ( dX_real::dx_real<T,Aa> & a, dX_real::dx_real<T,Ab> const& b ) {
  Algorithm constexpr A=commonAlgorithm<Aa,Ab>::algorithm;
  if ( A == Algorithm::Accurate ) {
...
template < typename T, Algorithm Aa >
INLINE auto const operator_mul_ow_body ( dX_real::dx_real<T,Aa> & a, T const& b ) {
  if ( Aa == Algorithm::Accurate ) {
...
//
template < typename Ta, Algorithm Aa, typename TXb, IF_T_mX<TXb> >
INLINE auto const operator_mul_ow ( dX_real::dx_real<Ta,Aa> & a, TXb const& b )
-> return_TXA<TXb,Ta,Aa,2> {
#if MX_REAL_USE_INF_NAN_EXCEPTION
  bool flag;
  auto e = dX_real::operator_mul_exception ( a, b, flag );
...
template < typename T, Algorithm A >
INLINE auto const operator_mul_ow ( dX_real::dx_real<T,A> & a, T const& b )
-> dX_real::dx_real<T,A> {
#if MX_REAL_USE_INF_NAN_EXCEPTION
  bool flag;
  auto e = dX_real::operator_mul_exception ( a, b, flag );
...
//
template < typename T, Algorithm Aa, Algorithm Ab >
INLINE auto const operator_div_ow_body ( dX_real::dx_real<T,Aa> & a, qX_real::qx_real<T,Ab> const& b ) {
  Algorithm constexpr A=commonAlgorithm<Aa,Ab>::algorithm;
  if ( A == Algorithm::Accurate ) {
...
template < typename T, Algorithm Aa, Algorithm Ab >
INLINE auto const operator_div_ow_body ( dX_real::dx_real<T,Aa> & a, tX_real::tx_real<T,Ab> const& b ) {
  Algorithm constexpr A=commonAlgorithm<Aa,Ab>::algorithm;
  if ( A == Algorithm::Accurate ) {
...
template < typename T, Algorithm Aa, Algorithm Ab >
INLINE auto const operator_div_ow_body ( dX_real::dx_real<T,Aa> & a, dX_real::dx_real<T,Ab> const& b ) {
  Algorithm constexpr A=commonAlgorithm<Aa,Ab>::algorithm;
  if ( A == Algorithm::Accurate ) {
...
template < typename T, Algorithm Aa >
INLINE auto const operator_div_ow_body ( dX_real::dx_real<T,Aa> & a, T const& b ) {
  if ( Aa == Algorithm::Accurate ) {
...
//
template < typename Ta, Algorithm Aa, typename TXb, IF_T_mX<TXb> >
INLINE auto const operator_div_ow ( dX_real::dx_real<Ta,Aa> & a, TXb const& b )
-> return_TXA<TXb,Ta,Aa,2> {
#if MX_REAL_USE_INF_NAN_EXCEPTION
  bool flag;
  auto e = dX_real::operator_div_exception ( a, b, flag );
...
template < typename T, Algorithm A >
INLINE auto const operator_div_ow ( dX_real::dx_real<T,A> & a, T const& b )
-> dX_real::dx_real<T,A> {
#if MX_REAL_USE_INF_NAN_EXCEPTION
  bool flag;
  auto e = dX_real::operator_div_exception ( a, b, flag );
