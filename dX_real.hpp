...
namespace mX_real {
  namespace dX_real {
    ...
    //
    template < typename T, Algorithm A >
    INLINE auto const operator_eq ( dX_real::dx_real<T,A> const& a, dX_real::dx_real<T,A> const& b ) {
    ...
    //
    template < typename T, Algorithm A >
    INLINE auto const operator_gt ( dX_real::dx_real<T,A> const& a, dX_real::dx_real<T,A> const& b ) {
      using TX = dX_real::dx_real<T,A>;
      int i; for(i=0; i<TX::L-1; i++) {
        if ( a.x[i] != b.x[i] ) { return a.x[i] > b.x[i]; }
      } return a.x[i] > b.x[i];
    ...
    //
    template < typename T, Algorithm A >
    INLINE auto const operator_lt ( dX_real::dx_real<T,A> const& a, dX_real::dx_real<T,A> const& b ) {
      using TX = dX_real::dx_real<T,A>;
      int i; for(i=0; i<TX::L-1; i++) {
        if ( a.x[i] != b.x[i] ) { return a.x[i] < b.x[i]; }
      } return a.x[i] < b.x[i];
    ...
    INLINE auto operator_add_ow ( dX_real::dx_real<Ta,Aa> & a, TXb<Ta,Ab> const& b ) {
#if MX_REAL_USE_INF_NAN_EXCEPTION
      bool flag;
      auto e = dX_real::operator_add_exception ( a, b, flag );
      if ( flag ) { return e; }
    ...
    //
    template < typename Ta, Algorithm Aa, template < typename _Tb_, Algorithm _Ab_ > typename TXb, Algorithm Ab, IF_A_owAble<Aa,Ab> >
    INLINE auto operator+= ( dX_real::dx_real<Ta,Aa> & a, TXb<Ta,Ab> const& b ) {
    ...
    //
    template < typename Ta, Algorithm Aa, template < typename _Tb_, Algorithm _Ab_ > typename TXb, Algorithm Ab, IF_A_owAble<Aa,Ab> >
    INLINE auto operator_mul_ow ( dX_real::dx_real<Ta,Aa> & a, TXb<Ta,Ab> const& b ) {
#if MX_REAL_USE_INF_NAN_EXCEPTION
      bool flag;
      auto e = dX_real::operator_mul_exception ( a, b, flag );
      if ( flag ) { return e; }
    ...
    //
    template < typename Ta, Algorithm Aa, template < typename _Tb_, Algorithm _Ab_ > typename TXb, Algorithm Ab, IF_A_owAble<Aa,Ab> >
    INLINE auto operator_div_ow ( dX_real::dx_real<Ta,Aa> & a, TXb<Ta,Ab> const& b ) {
#if MX_REAL_USE_INF_NAN_EXCEPTION
      bool flag;
      auto e = dX_real::operator_div_exception ( a, b, flag );
      if ( flag ) { return e; }
